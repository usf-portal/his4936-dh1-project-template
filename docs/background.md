...
The historiography of ACT UP began in 1989 with ACT UP activist Larry Kramer's seminal work "Reports from the Holocaust." Kramer is the man traditionally credited with the formation of ACT UP. His work was published just two years after the founding of ACT UP and displays an organization in evolution. This work serves as a primary and secondary source, the original intention of the source was to provide a memoir of activism as well as a history of the AIDS crisis from its first reports. 
...
Cohen's considers class and social inequalities. Because of Cohen's consideration of class, he is able to examine the "passing" that many white gay men experienced OK HERE TALK ABOUT CLASS AND HOW THEIR WHITE MALE PRIVLEDGE WORKED, AND HOW THIS WORKS IN AN INTERSECTIONAL ANALYSIS.  
